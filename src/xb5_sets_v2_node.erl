...
-define(ROTATED(UpElem, UpdatedLeft, UpdatedRight),
    {rotated, UpElem, UpdatedLeft, UpdatedRight}
).
...
-define(INTERNAL4_C1_REBALANCE(UpdatedC1, ChildExtreme),
    del_rebalance_INTERNAL4_C1(E1, E2, E3, E4, UpdatedC1, C2, C3, C4, C5, ChildExtreme)
).
...
-define(INTERNAL4_C5_REBALANCE(UpdatedC5, ChildExtreme),
    del_rebalance_INTERNAL4_C5(E1, E2, E3, E4, C1, C2, C3, C4, UpdatedC5, ChildExtreme)
).
...
-define(INTERNAL3_C1_REBALANCE(UpdatedC1, ChildExtreme),
    del_rebalance_INTERNAL3_C1(E1, E2, E3, UpdatedC1, C2, C3, C4, ChildExtreme)
).
...
-define(INTERNAL3_C4_REBALANCE(UpdatedC4, ChildExtreme),
    del_rebalance_INTERNAL3_C4(E1, E2, E3, C1, C2, C3, UpdatedC4, ChildExtreme)
).
...
-define(INTERNAL2_C1_REBALANCE(UpdatedC1, ChildExtreme),
    del_rebalance_INTERNAL2_C1(E1, E2, UpdatedC1, C2, C3, ChildExtreme)
).
-define(INTERNAL2_C2_REBALANCE(UpdatedC2),
    del_rebalance_INTERNAL2_C2(E1, E2, C1, UpdatedC2, C3)
).
-define(INTERNAL2_C3_REBALANCE(UpdatedC3, ChildExtreme),
    del_rebalance_INTERNAL2_C3(E1, E2, C1, C2, UpdatedC3, ChildExtreme)
).
...
delete_att(Elem, Root) ->
    delete_att_recur(Elem, Root, none).
...
-spec filtermap_to_list(fun((Elem) -> {true, MappedElem} | boolean()), t(Elem)) ->
    [MappedElem].
filtermap_to_list(Fun, ?INTERNAL1_MATCH_ALL) ->
...
largest(?INTERNAL1_MATCH(E1, _, C2)) ->
    largest_recur(C2, E1);
largest(Root) when Root =/= ?LEAF0 ->
    largest_recur(Root, not_applicable).
...
smallest(?INTERNAL1_MATCH(E1, C1, _)) ->
    smallest_recur(C1, E1);
smallest(Root) when Root =/= ?LEAF0 ->
    smallest_recur(Root, not_applicable).
...
take_largest(?INTERNAL1_MATCH_ALL) ->
    case take_largest_recur(C2, rightmost) of
...
take_smallest(Root) ->
    take_smallest_recur(Root, leftmost).
...
delete_att_recur(Elem, Node, Extreme) ->
    case Node of
        ?INTERNAL2_MATCH_ALL ->
            delete_att_INTERNAL2(Elem, ?INTERNAL2_ARGS, Extreme);
        %
        ?INTERNAL3_MATCH_ALL ->
            delete_att_INTERNAL3(Elem, ?INTERNAL3_ARGS, Extreme);
        %
        ?INTERNAL4_MATCH_ALL ->
            delete_att_INTERNAL4(Elem, ?INTERNAL4_ARGS, Extreme);
        %
        ?LEAF2_MATCH_ALL ->
...
delete_att_INTERNAL4(Elem, ?INTERNAL4_ARGS, Extreme) ->
    ?GAP_SEARCH4(
        ...
        %
        delete_att_INTERNAL4_C1(Elem, ?INTERNAL4_ARGS, Extreme),
...
delete_att_INTERNAL4_E2(?INTERNAL4_ARGS_IGN_E2) ->
    ?TAKEN(ReplacementE, UpdatedC2) = take_largest_recur(C2, middle),
...
delete_att_INTERNAL4_E3(?INTERNAL4_ARGS_IGN_E3) ->
    ?TAKEN(ReplacementE, UpdatedC4) = take_smallest_recur(C4, middle),
...
delete_att_INTERNAL4_E4(?INTERNAL4_ARGS_IGN_E4) ->
    ?TAKEN(ReplacementE, UpdatedC4) = take_largest_recur(C4, middle),
...
delete_att_INTERNAL3(Elem, ?INTERNAL3_ARGS, Extreme) ->
    ?GAP_SEARCH3(
        ...
        %
        delete_att_INTERNAL3_C1(Elem, ?INTERNAL3_ARGS, Extreme),
        delete_att_INTERNAL3_C2(Elem, ?INTERNAL3_ARGS),
        delete_att_INTERNAL3_C3(Elem, ?INTERNAL3_ARGS),
        delete_att_INTERNAL3_C4(Elem, ?INTERNAL3_ARGS, Extreme)
    ).
...
delete_att_INTERNAL3_C1(Elem, ?INTERNAL3_ARGS, Extreme) ->
    ...
    ?INTERNAL3_C1_REBALANCE(UpdatedC1, ChildExtreme).
...
delete_att_INTERNAL3_C4(Elem, ?INTERNAL3_ARGS, Extreme) ->
    ChildExtreme = rightmost_child_extreme(Extreme),
    UpdatedC4 = delete_att_recur(Elem, C4, ChildExtreme),

    ?INTERNAL3_C4_REBALANCE(UpdatedC4, ChildExtreme).
...
delete_att_INTERNAL3_E2(?INTERNAL3_ARGS_IGN_E2) ->
    ?TAKEN(ReplacementE, UpdatedC3) = take_smallest_recur(C3, middle),
...
delete_att_INTERNAL3_E3(?INTERNAL3_ARGS_IGN_E3) ->
    ?TAKEN(ReplacementE, UpdatedC3) = take_largest_recur(C3, middle),
...
-compile({inline, delete_att_INTERNAL2 / ?INTERNAL2_ARITY_PLUS2}).
delete_att_INTERNAL2(Elem, ?INTERNAL2_ARGS, Extreme) ->
    ?GAP_SEARCH2(
        Elem,
        E1,
        ...
        %
        delete_att_INTERNAL2_C1(Elem, ?INTERNAL2_ARGS, Extreme),
        delete_att_INTERNAL2_C2(Elem, ?INTERNAL2_ARGS),
        delete_att_INTERNAL2_C3(Elem, ?INTERNAL2_ARGS, Extreme)
    ).

-compile({inline, delete_att_INTERNAL2_C1 / ?INTERNAL2_ARITY_PLUS2}).
delete_att_INTERNAL2_C1(Elem, ?INTERNAL2_ARGS, Extreme) ->
    ChildExtreme = leftmost_child_extreme(Extreme),
    UpdatedC1 = delete_att_recur(Elem, C1, ChildExtreme),

    ?INTERNAL2_C1_REBALANCE(UpdatedC1, ChildExtreme).
...
-compile({inline, delete_att_INTERNAL2_C3 / ?INTERNAL2_ARITY_PLUS2}).
delete_att_INTERNAL2_C3(Elem, ?INTERNAL2_ARGS, Extreme) ->
    ChildExtreme = rightmost_child_extreme(Extreme),
    UpdatedC3 = delete_att_recur(Elem, C3, ChildExtreme),

    ?INTERNAL2_C3_REBALANCE(UpdatedC3, ChildExtreme).
...
delete_att_INTERNAL1_E1(?INTERNAL1_ARGS_IGN_E1) ->
    case take_smallest_recur(C2, middle) of
        ?TAKEN(ReplacementE, UpdatedC2) ->
...
%
is_equal_recur(?LEAF1_MATCH_ALL, Iter) ->
    next_elem_is_equal(E1, Iter);
is_equal_recur(?LEAF0, Iter) ->
    Iter.
...
fwd_iterator_recur(?INTERNAL4_MATCH_ALL, Acc) ->
    ...
    fwd_iterator_recur(C1, Acc2);
%
fwd_iterator_recur(?LEAF1_MATCH(E1), Acc) ->
    Acc2 = [?ITER_ELEM(E1) | Acc],
    Acc2;
fwd_iterator_recur(?LEAF0, Acc) ->
    Acc.
...
%
rev_iterator_recur(?LEAF1_MATCH(E1), Acc) ->
    Acc2 = [?ITER_ELEM(E1) | Acc],
    Acc2;
rev_iterator_recur(?LEAF0, Acc) ->
    Acc.
...
bound_fwd_iterator_recur(Elem, Node, Acc) ->
    case Node of
        ...
        %
        ?LEAF1_MATCH_ALL ->
            bound_fwd_iterator_LEAF1(Elem, ?LEAF1_ARGS, Acc);
        %
        ?LEAF0 ->
            Acc
    end.
...
bound_rev_iterator_recur(Elem, Node, Acc) ->
    case Node of
        ...
        %
        ?LEAF1_MATCH_ALL ->
            bound_rev_iterator_LEAF1(Elem, ?LEAF1_ARGS, Acc);
        %
        ?LEAF0 ->
            Acc
    end.
...
largest_recur(Node, LargestInParent) ->
    case Node of
        ?INTERNAL2_MATCH(_, E2, _, _, C3) ->
            largest_recur(C3, E2);
        %
        ?INTERNAL3_MATCH(_, _, E3, _, _, _, C4) ->
            largest_recur(C4, E3);
        %
        ?INTERNAL4_MATCH(_, _, _, E4, _, _, _, _, C5) ->
            largest_recur(C5, E4);
        %
        ?LEAF2_MATCH(_, E2) ->
            E2;
...
smallest_recur(Node, SmallestInParent) ->
    case Node of
        ?INTERNAL2_MATCH(E1, _, C1, _, _) ->
            smallest_recur(C1, E1);
        %
        ?INTERNAL3_MATCH(E1, _, _, C1, _, _, _) ->
            smallest_recur(C1, E1);
        %
        ?INTERNAL4_MATCH(E1, _, _, _, C1, _, _, _, _) ->
            smallest_recur(C1, E1);
        %
        ?LEAF2_MATCH(E1, _) ->
            E1;
...
structural_stats_recur(Node, Acc, Height) ->
    case Node of
        ...
        %
        ?LEAF0 ->
            Acc2 = xb5_structural_stats:inc_count(leaf0, Acc),
            xb5_structural_stats:set_height(Height, Acc2)
    end.
...
take_largest_recur(Node, Extreme) ->
    case Node of
        ?INTERNAL2_MATCH_ALL ->
            ChildExtreme = rightmost_child_extreme(Extreme),

            case take_largest_recur(C3, ChildExtreme) of
                ?TAKEN(Taken, UpdatedC3) ->
                    ?TAKEN(Taken, ?INTERNAL2_C3_REBALANCE(UpdatedC3, ChildExtreme));
                %
                none ->
                    ?TAKEN(E2, ?new_INTERNAL1(E1, C1, C2))
            end;
        %
        ?INTERNAL3_MATCH_ALL ->
            ChildExtreme = rightmost_child_extreme(Extreme),

            case take_largest_recur(C4, ChildExtreme) of
                ?TAKEN(Taken, UpdatedC4) ->
                    ?TAKEN(Taken, ?INTERNAL3_C4_REBALANCE(UpdatedC4, ChildExtreme));
                %
                none ->
                    ?TAKEN(E3, ?new_INTERNAL2(E1, E2, C1, C2, C3))
            end;
        %
        ?INTERNAL4_MATCH_ALL ->
            ChildExtreme = rightmost_child_extreme(Extreme),

            case take_largest_recur(C5, ChildExtreme) of
                ?TAKEN(Taken, UpdatedC5) ->
                    ?TAKEN(Taken, ?INTERNAL4_C5_REBALANCE(UpdatedC5, ChildExtreme));
                %
                none ->
                    ?TAKEN(E4, ?new_INTERNAL3(E1, E2, E3, C1, C2, C3, C4))
            end;
        %
        ?LEAF2_MATCH_ALL ->
...
ins_rebalance_into_left_leaf_maybe(Node, Pos, NewElem, ParentE, Left) ->
    case Left of
        ...
        %
        ?LEAF1_MATCH(LE1) ->
            UpdatedLeft = ?new_LEAF2(LE1, ParentE),
            ins_rebalance_into_left_leaf(Node, Pos, NewElem, UpdatedLeft);
        %
        ?LEAF0 ->
            UpdatedLeft = ?new_LEAF1(ParentE),
            ins_rebalance_into_left_leaf(Node, Pos, NewElem, UpdatedLeft);
        %
        _ ->
...
ins_rebalance_into_right_leaf_maybe(Node, Pos, NewElem, ParentE, Right) ->
    case Right of
        ...
        %
        ?LEAF1_MATCH(RE1) ->
            UpdatedRight = ?new_LEAF2(ParentE, RE1),
            ins_rebalance_into_right_leaf(Node, Pos, NewElem, UpdatedRight);
        %
        ?LEAF0 ->
            UpdatedRight = ?new_LEAF1(ParentE),
            ins_rebalance_into_right_leaf(Node, Pos, NewElem, UpdatedRight);
        %
        _ ->
            ins_rebalance_split_leaf(Node, Pos, NewElem)
...
-compile({inline, del_rebalance_INTERNAL4_C1 / ?INTERNAL4_ARITY_PLUS1}).
del_rebalance_INTERNAL4_C1(?INTERNAL4_ARGS, ChildExtreme) ->
    case del_rebalance_maybe_from_right_sibling(C1, E1, C2, ChildExtreme) of
        balanced ->
            ?INTERNAL4_UPD_C1(C1);
        %
        badkey ->
...
-compile({inline, del_rebalance_INTERNAL4_C5 / ?INTERNAL4_ARITY_PLUS1}).
del_rebalance_INTERNAL4_C5(?INTERNAL4_ARGS, ChildExtreme) ->
    case del_rebalance_maybe_from_left_sibling(C5, E4, C4, ChildExtreme) of
        balanced ->
            ?INTERNAL4_UPD_C5(C5);
        %
        badkey ->
...
-compile({inline, del_rebalance_INTERNAL3_C1 / ?INTERNAL3_ARITY_PLUS1}).
del_rebalance_INTERNAL3_C1(?INTERNAL3_ARGS, ChildExtreme) ->
    case del_rebalance_maybe_from_right_sibling(C1, E1, C2, ChildExtreme) of
        balanced ->
            ?INTERNAL3_UPD_C1(C1);
        %
...
-compile({inline, del_rebalance_INTERNAL3_C4 / ?INTERNAL3_ARITY_PLUS1}).
del_rebalance_INTERNAL3_C4(?INTERNAL3_ARGS, ChildExtreme) ->
    case del_rebalance_maybe_from_left_sibling(C4, E3, C3, ChildExtreme) of
        balanced ->
            ?INTERNAL3_UPD_C4(C4);
        %
        badkey ->
...
-compile({inline, del_rebalance_INTERNAL2_C1 / ?INTERNAL2_ARITY_PLUS1}).
del_rebalance_INTERNAL2_C1(?INTERNAL2_ARGS, ChildExtreme) ->
    case del_rebalance_maybe_from_right_sibling(C1, E1, C2, ChildExtreme) of
        balanced ->
            ?INTERNAL2_UPD_C1(C1);
        %
...
-compile({inline, del_rebalance_INTERNAL2_C3 / ?INTERNAL2_ARITY_PLUS1}).
del_rebalance_INTERNAL2_C3(?INTERNAL2_ARGS, ChildExtreme) ->
    case del_rebalance_maybe_from_left_sibling(C3, E2, C2, ChildExtreme) of
        balanced ->
            ?INTERNAL2_UPD_C3(C3);
        %
        badkey ->
...
del_rebalance_INTERNAL1_C1(?INTERNAL1_ARGS) ->
    case del_rebalance_maybe_from_right_sibling(C1, E1, C2, leftmost) of
        balanced ->
            ?INTERNAL1_UPD_C1(C1);
        %
        badkey ->
...
del_rebalance_INTERNAL1_C2(?INTERNAL1_ARGS) ->
    case del_rebalance_maybe_from_left_sibling(C2, E1, C1, rightmost) of
        balanced ->
            ?INTERNAL1_UPD_C2(C2);
        %
        badkey ->
...
del_rebalance_maybe_from_right_sibling(Child, RParentE, Right, ChildExtreme) ->
    case Child of
        ...
        %
        ?LEAF1_MATCH(CElem) when ChildExtreme =/= leftmost ->
...
del_rebalance_leaf_from_right_sibling(CElem, RParentE, Right) ->
    case Right of
        ...
        %
        ?LEAF1_MATCH_ALL ->
            MergedNode = ?new_LEAF3(CElem, RParentE, E1),
            MergedNode;
        %
        ?LEAF0 ->
            MergedNode = ?new_LEAF2(CElem, RParentE),
            MergedNode
    end.
...
del_rebalance_maybe_from_left_sibling(Child, LParentE, Left, ChildExtreme) ->
    case Child of
        ?INTERNAL1_MATCH(CElem, CLeft, CRight) ->
        ...
        %
        ?LEAF1_MATCH(CElem) when ChildExtreme =/= rightmost ->
...
del_rebalance_leaf_from_left_sibling(
    ...
    case Left of
        ...
        %
        ?LEAF1_MATCH_ALL ->
            MergedNode = ?new_LEAF3(E1, LParentE, CElem),
            MergedNode;
        %
        ?LEAF0 ->
            MergedNode = ?new_LEAF2(LParentE, CElem),
            MergedNode
    end.
...
leftmost_child_extreme(leftmost) -> leftmost;
leftmost_child_extreme(none) -> leftmost;
leftmost_child_extreme(_) -> middle.

rightmost_child_extreme(rightmost) -> rightmost;
rightmost_child_extreme(none) -> rightmost;
rightmost_child_extreme(_) -> middle.
