...
-record(b5_sets_forward_iter, {steps :: [iterator_step(_)]}).
-type forward_iter(Element) :: #b5_sets_forward_iter{steps :: [iterator_step(Element)]}.

-record(b5_sets_reverse_iter, {steps :: [iterator_step(_)]}).
-type reverse_iter(Element) :: #b5_sets_reverse_iter{steps :: [iterator_step(Element)]}.
