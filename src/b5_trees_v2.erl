...
-record(b5_trees_v2, {size, root}).

-opaque tree(Key, Value) :: #b5_trees_v2{
    size :: non_neg_integer(),
    root :: b5_trees_v2_node:t(Key, Value)
}.
-export_type([tree/2]).

%%%%%%%

-type iter(Key, Value) :: b5_trees_v2_node:iter(Key, Value).
-export_type([iter/2]).
...
delete(Key, #b5_trees_v2{root = Root, size = Size} = Tree) ->
    case b5_trees_v2_node:delete_att(Key, Root) of
        none ->
            error_badkey(Key);
        %
        UpdatedRoot ->
...
-spec delete_any(Key, Tree) -> UpdatedTree when
    Key :: term(), Value :: term(), Tree :: tree(Key, Value), UpdatedTree :: tree(Key, Value).
delete_any(Key, #b5_trees_v2{root = Root, size = Size} = Tree) ->
    case b5_trees_v2_node:delete_att(Key, Root) of
        none ->
            Tree;
        %
...
enter(Key, Value, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    case b5_trees_v2_node:insert_att(Key, eager, Value, Root) of
        none ->
            UpdatedRoot = b5_trees_v2_node:update_att(Key, eager, Value, Root),
            Tree#b5_trees_v2{root = UpdatedRoot};
        %
        UpdatedRoot ->
            Tree#b5_trees_v2{
                root = UpdatedRoot,
...
foldl(Fun, Acc0, #b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:foldl(Fun, Acc0, Root).
...
-spec foldr(fun((Key, Value, Acc1) -> Acc2), Acc0, tree(Key, Value)) -> AccN when
    AccN :: Acc2, Acc2 :: Acc1, Acc1 :: Acc0.
foldr(Fun, Acc0, #b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:foldr(Fun, Acc0, Root).
...
get(Key, #b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:get(Key, Root).
...
insert(Key, Value, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    case b5_trees_v2_node:insert_att(Key, eager, Value, Root) of
        none ->
...
insert_with(Key, Fun, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    case b5_trees_v2_node:insert_att(Key, lazy, Fun, Root) of
        none ->
            error_key_exists(Key);
        %
        UpdatedRoot ->
...
is_defined(Key, #b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:is_defined(Key, Root).

-if(?OTP_RELEASE >= 27).
-doc "Returns `true` if `Tree` is an empty tree, otherwise `false`.".
-endif.
-spec is_empty(tree(_, _)) -> boolean().
is_empty(#b5_trees_v2{size = Size}) ->
    Size =:= 0.
...
-spec iterator(Tree) -> Iter when
    Tree :: tree(Key, Value),
    Iter :: b5_trees_v2_node:iter(Key, Value).
...
iterator(#b5_trees_v2{root = Root}, Order) ->
    b5_trees_v2_node:iterator(Root, Order).
...
iterator_from(Key, #b5_trees_v2{root = Root}, Order) ->
    b5_trees_v2_node:iterator_from(Key, Root, Order).

-if(?OTP_RELEASE >= 27).
-doc "Returns the keys in `Tree` as an ordered list.".
-endif.
-spec keys(Tree) -> [Key] when Tree :: tree(Key, _).
keys(#b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:keys(Root).
...
larger(Key, #b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:larger(Key, Root).
...
largest(#b5_trees_v2{size = Size, root = Root}) when Size =/= 0 ->
    b5_trees_v2_node:largest(Root);
largest(#b5_trees_v2{}) ->
    error_empty_tree().
...
lookup(Key, #b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:lookup(Key, Root).
...
map(Fun, #b5_trees_v2{root = Root} = Tree) ->
    Tree#b5_trees_v2{root = b5_trees_v2_node:map(Fun, Root)}.

-if(?OTP_RELEASE >= 27).
-doc "Returns a new empty tree.".
-endif.
-spec new() -> tree(_, _).
new() -> #b5_trees_v2{root = b5_trees_v2_node:new(), size = 0}.
...
smaller(Key, #b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:smaller(Key, Root).
...
smallest(#b5_trees_v2{size = Size, root = Root}) when Size =/= 0 ->
    b5_trees_v2_node:smallest(Root);
smallest(#b5_trees_v2{}) ->
    error_empty_tree().

% TODO document
structural_stats(#b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:structural_stats(Root).
...
take(Key, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    case b5_trees_v2_node:take_att(Key, Root) of
        none ->
            error_badkey(Key);
        %
        [TakenPair | UpdatedRoot] ->
            UpdatedTree = Tree#b5_trees_v2{size = Size - 1, root = UpdatedRoot},
...
take_any(Key, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    case b5_trees_v2_node:take_att(Key, Root) of
        none ->
            error;
        %
...
take_largest(#b5_trees_v2{size = Size, root = Root} = Tree) when Size =/= 0 ->
    [TakenPair | UpdatedRoot] = b5_trees_v2_node:take_largest(Root),
    UpdatedTree = Tree#b5_trees_v2{size = Size - 1, root = UpdatedRoot},

    [Key | Value] = TakenPair,
    {Key, Value, UpdatedTree};
take_largest(#b5_trees_v2{}) ->
    error_empty_tree().
...
take_smallest(#b5_trees_v2{size = Size, root = Root} = Tree) when Size =/= 0 ->
    [TakenPair | UpdatedRoot] = b5_trees_v2_node:take_smallest(Root),
    UpdatedTree = Tree#b5_trees_v2{size = Size - 1, root = UpdatedRoot},

    [Key | Value] = TakenPair,
    {Key, Value, UpdatedTree};
take_smallest(#b5_trees_v2{}) ->
    error_empty_tree().
...
to_list(#b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:to_list(Root).
...
update(Key, Value, #b5_trees_v2{root = Root} = Tree) ->
    case b5_trees_v2_node:update_att(Key, eager, Value, Root) of
        none ->
            error_badkey(Key);
        %
        UpdatedRoot ->
...
update_with(Key, Fun, #b5_trees_v2{root = Root} = Tree) ->
    case b5_trees_v2_node:update_att(Key, lazy, Fun, Root) of
        none ->
            error_badkey(Key);
        %
        UpdatedRoot ->
...
update_with(Key, Fun, Init, #b5_trees_v2{root = Root} = Tree) ->
    case b5_trees_v2_node:update_att(Key, lazy, Fun, Root) of
        none ->
            Tree#b5_trees_v2{
                root = b5_trees_v2_node:insert_att(Key, eager, Init, Root),
                size = Tree#b5_trees_v2.size + 1
            };
        %
        UpdatedRoot ->
            Tree#b5_trees_v2{root = UpdatedRoot}
...
values(#b5_trees_v2{root = Root}) ->
    b5_trees_v2_node:values(Root).
...
want to reuse `b5_trees_v2_node` functionality while wrapping the tree
...
-spec from_constituent_parts(#{
    root := b5_trees_v2_node:t(Key, Value), size := non_neg_integer()
}) -> tree(Key, Value).
from_constituent_parts(#{root := Root, size := Size}) when is_integer(Size), Size >= 0 ->
    #b5_trees_v2{root = Root, size = Size}.
...
-spec to_constituent_parts(tree(Key, Value) | term()) ->
    {ok, #{root := b5_trees_v2_node:t(Key, Value), size := non_neg_integer()}} | error.
to_constituent_parts(#b5_trees_v2{root = Root, size = Size}) when is_integer(Size), Size >= 0 ->
...
from_list_recur([], Size, Root) ->
    #b5_trees_v2{size = Size, root = Root}.
