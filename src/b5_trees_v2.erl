...
delete(Key, #b5_trees_v2{root = Root, size = Size} = Tree) ->
    Tree#b5_trees_v2{
        root = b5_trees_v2_node:delete(Key, Root),
        size = Size - 1
    }.

delete_any(Key, #b5_trees_v2{root = Root, size = Size} = Tree) ->
    case b5_trees_v2_node:is_defined(Key, Root) of
        true ->
            Tree#b5_trees_v2{
                root = b5_trees_v2_node:delete(Key, Root),
                size = Size - 1
...
enter(Key, Value, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    case b5_trees_v2_node:is_defined(Key, Root) of
        true ->
            UpdatedRoot = b5_trees_v2_node:update(Key, eager, Value, Root),
            Tree#b5_trees_v2{root = UpdatedRoot};
        %
        false ->
            Tree#b5_trees_v2{
                root = b5_trees_v2_node:insert(Key, eager, Value, Root),
                size = Size + 1
            }
    end.
...
insert_with(Key, Fun, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    Tree#b5_trees_v2{
        size = Size + 1,
        root = b5_trees_v2_node:insert(Key, lazy, Fun, Root)
    }.
...
smallest(#b5_trees_v2{root = Root}) ->
...
take(Key, #b5_trees_v2{size = Size, root = Root} = Tree) ->
    [TakenPair | UpdatedRoot] = b5_trees_v2_node:take(Key, Root),
...
take_largest(#b5_trees_v2{size = Size, root = Root} = Tree) ->
...
take_smallest(#b5_trees_v2{size = Size, root = Root} = Tree) ->
...
update(Key, Value, #b5_trees_v2{root = Root} = Tree) ->
    Tree#b5_trees_v2{root = b5_trees_v2_node:update(Key, eager, Value, Root)}.
...
update_with(Key, Fun, #b5_trees_v2{root = Root} = Tree) ->
    Tree#b5_trees_v2{root = b5_trees_v2_node:update(Key, lazy, Fun, Root)}.
...
update_with(Key, Fun, Init, #b5_trees_v2{root = Root} = Tree) ->
    case b5_trees_v2_node:lookup(Key, Root) of
        {value, PrevValue} ->
            UpdatedValue = Fun(PrevValue),
            UpdatedRoot = b5_trees_v2_node:update(Key, eager, UpdatedValue, Root),
            Tree#b5_trees_v2{root = UpdatedRoot};
        %
        none ->
            Tree#b5_trees_v2{
                root = b5_trees_v2_node:insert(Key, eager, Init, Root),
