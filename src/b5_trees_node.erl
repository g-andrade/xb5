...
%
-define(NEW_INTERNAL1(K1, V1, C1, C2), {internal1, K1, V1, C1, C2}).
-define(NEW_LEAF2(K1, K2, V1, V2), {K1, K2, V1, V2}).
%
%
...
%
-define(NEW_INTERNAL2(K1, K2, Values, C1, C2, C3), {K1, K2, Values, C1, C2, C3}).
-define(NEW_LEAF3(K1, K2, K3, V1, V2, V3), {leaf3, K1, K2, K3, V1, V2, V3}).
%
%
% INTERNAL3 vs LEAF4 (8 elements):
%   Prioritise INTERNAL3. Same rationale as in previous case.
%
-define(NEW_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4), {K1, K2, K3, Values, C1, C2, C3, C4}).
-define(NEW_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4), {leaf4, K1, K2, K3, K4, V1, V2, V3, V4}).
%
%
% Conflict-free:
%
-define(NEW_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5),
    {K1, K2, K3, K4, Values, C1, C2, C3, C4, C5}
).
-define(NEW_LEAF1(K1, V1), [K1 | V1]).
-define(NEW_LEAF0, leaf0).
...
-define(MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5),
    ?NEW_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)
).
-define(MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4),
    ?NEW_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)
).
-define(MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3), ?NEW_INTERNAL2(K1, K2, Values, C1, C2, C3)).
-define(MATCH_INTERNAL1(K1, V1, C1, C2), {_, K1, V1, C1, C2}).
-define(MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4), {_, K1, K2, K3, K4, V1, V2, V3, V4}).
-define(MATCH_LEAF3(K1, K2, K3, V1, V2, V3), {_, K1, K2, K3, V1, V2, V3}).
-define(MATCH_LEAF2(K1, K2, V1, V2), ?NEW_LEAF2(K1, K2, V1, V2)).
-define(MATCH_LEAF1(K1, V1), ?NEW_LEAF1(K1, V1)).
-define(MATCH_LEAF0, ?NEW_LEAF0).
...
-type node_leaf2(Key, Value) :: ?NEW_LEAF2(Key, Key, Value, Value).
...
foldl(Fun, Acc, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    Acc2 = Fun(K1, V1, foldl_recur(Fun, Acc, C1)),
    foldl_recur(Fun, Acc2, C2);
foldl(Fun, Acc, ?MATCH_LEAF1(K1, V1)) ->
    Fun(K1, V1, Acc);
foldl(_Fun, Acc, ?MATCH_LEAF0) ->
    Acc;
foldl(Fun, Acc, Node) ->
...
-spec foldr(fun((Key, Value, Acc1) -> Acc2), Acc0, t(Key, Value)) -> AccN when
    AccN :: Acc2, Acc2 :: Acc1, Acc1 :: Acc0.
foldr(Fun, Acc, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    Acc2 = Fun(K1, V1, foldr_recur(Fun, Acc, C2)),
    foldr_recur(Fun, Acc2, C1);
foldr(Fun, Acc, ?MATCH_LEAF1(K1, V1)) ->
    Fun(K1, V1, Acc);
foldr(_Fun, Acc, ?MATCH_LEAF0) ->
    Acc;
foldr(Fun, Acc, Node) ->
...
get(Key, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    get_internal1(Key, K1, V1, C1, C2);
get(Key, ?MATCH_LEAF1(K1, V1)) ->
    get_leaf1(Key, K1, V1);
get(Key, ?MATCH_LEAF0) ->
    error_badkey(Key);
get(Key, Node) ->
...
insert(Key, ValueEval, ValueWrap, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    insert_internal1(Key, ValueEval, ValueWrap, K1, V1, C1, C2);
insert(Key, ValueEval, ValueWrap, ?MATCH_LEAF1(K1, V1)) ->
    insert_leaf1(Key, ValueEval, ValueWrap, K1, V1);
insert(Key, ValueEval, ValueWrap, ?MATCH_LEAF0) ->
...
keys(?MATCH_INTERNAL1(K1, _, C1, C2)) ->
    Acc2 = [K1 | keys_recur(C2, [])],
    keys_recur(C1, Acc2);
keys(?MATCH_LEAF1(K1, _)) ->
    [K1];
keys(?MATCH_LEAF0) ->
    [];
keys(Node) ->
...
larger(Key, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    case Key < K1 of
        true ->
...
largest(?MATCH_INTERNAL1(_, _, _, C2)) ->
    largest_recur(C2);
largest(?MATCH_LEAF1(K1, V1)) ->
    {K1, V1};
largest(?MATCH_LEAF0) ->
    error_empty_tree();
largest(Node) ->
...
new() ->
    ...
    % type, it shouldn't...
    b5_trees_util:dialyzer_opaque_term(?NEW_LEAF0).
...
map(Fun, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    ?NEW_INTERNAL1(
        K1,
        Fun(K1, V1),
        map_recur(Fun, C1),
...
smaller(Key, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    case Key > K1 of
        true ->
...
smallest(?MATCH_INTERNAL1(_, _, C1, _)) ->
    smallest_recur(C1);
smallest(?MATCH_LEAF1(K1, V1)) ->
    {K1, V1};
smallest(?MATCH_LEAF0) ->
    error_empty_tree();
smallest(Node) ->
    smallest_recur(Node).
...
to_list(?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    Acc2 = [{K1, V1} | to_list_recur(C2, [])],
    to_list_recur(C1, Acc2);
to_list(?MATCH_LEAF1(K1, V1)) ->
    [{K1, V1}];
to_list(?MATCH_LEAF0) ->
    [];
to_list(Node) ->
...
update(Key, ValueEval, ValueWrap, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    update_internal1(Key, ValueEval, ValueWrap, K1, V1, C1, C2);
update(Key, ValueEval, ValueWrap, ?MATCH_LEAF1(K1, V1)) ->
    update_leaf1(Key, ValueEval, ValueWrap, K1, V1);
update(Key, _ValueWrap, _ValueEval, ?MATCH_LEAF0) ->
    error_badkey(Key);
...
values(?MATCH_INTERNAL1(_, V1, C1, C2)) ->
    Acc2 = [V1 | values_recur(C2, [])],
    values_recur(C1, Acc2);
values(?MATCH_LEAF1(_, V1)) ->
    [V1];
values(?MATCH_LEAF0) ->
    [];
values(Node) ->
...
get_recur(Key, ?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)) ->
    get_internal4(Key, K1, K2, K3, K4, Values, C1, C2, C3, C4, C5);
get_recur(Key, ?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    get_internal3(Key, K1, K2, K3, Values, C1, C2, C3, C4);
get_recur(Key, ?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    get_internal2(Key, K1, K2, Values, C1, C2, C3);
get_recur(Key, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    get_leaf4(Key, K1, K2, K3, K4, V1, V2, V3, V4);
get_recur(Key, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    get_leaf3(Key, K1, K2, K3, V1, V2, V3);
get_recur(Key, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
...
insert_recur(
    Key, ValueEval, ValueWrap, ?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)
) ->
    insert_internal4(Key, ValueEval, ValueWrap, K1, K2, K3, K4, Values, C1, C2, C3, C4, C5);
insert_recur(Key, ValueEval, ValueWrap, ?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    insert_internal3(Key, ValueEval, ValueWrap, K1, K2, K3, Values, C1, C2, C3, C4);
insert_recur(Key, ValueEval, ValueWrap, ?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    insert_internal2(Key, ValueEval, ValueWrap, K1, K2, Values, C1, C2, C3);
insert_recur(Key, ValueEval, ValueWrap, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    insert_leaf4(Key, ValueEval, ValueWrap, K1, K2, K3, K4, V1, V2, V3, V4);
insert_recur(Key, ValueEval, ValueWrap, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    insert_leaf3(Key, ValueEval, ValueWrap, K1, K2, K3, V1, V2, V3);
insert_recur(Key, ValueEval, ValueWrap, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
            ...
            if
                Key < K3 ->
                    case insert_recur(Key, ValueEval, ValueWrap, C3) of
                        ...
                        UpdatedC3 ->
                            ?NEW_INTERNAL3(K1, K2, K3, Values, C1, C2, UpdatedC3, C4)
                    end;
                Key > K3 ->
                    case insert_recur(Key, ValueEval, ValueWrap, C4) of
                        {split, SplitK, SplitV, SplitL, SplitR} ->
                        ...
                        UpdatedC4 ->
                            ?NEW_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, UpdatedC4)
                    end;
                true ->
                    error_key_exists(Key)
            end;
            ...
            if
                Key > K1 ->
                    case insert_recur(Key, ValueEval, ValueWrap, C2) of
                        ...
                        UpdatedC2 ->
                            ?NEW_INTERNAL3(K1, K2, K3, Values, C1, UpdatedC2, C3, C4)
                    end;
                Key < K1 ->
                    case insert_recur(Key, ValueEval, ValueWrap, C1) of
                        {split, SplitK, SplitV, SplitL, SplitR} ->
                        ...
                        UpdatedC1 ->
                            ?NEW_INTERNAL3(K1, K2, K3, Values, UpdatedC1, C2, C3, C4)
                    end;
                true ->
                    error_key_exists(Key)
            end;
    ...
    if
            ...
            if
                Key < K2 ->
                    case insert_recur(Key, ValueEval, ValueWrap, C2) of
                        ...
                        UpdatedC2 ->
                            ?NEW_INTERNAL2(K1, K2, Values, C1, UpdatedC2, C3)
                    end;
                Key > K2 ->
                    case insert_recur(Key, ValueEval, ValueWrap, C3) of
                        {split, SplitK, SplitV, SplitL, SplitR} ->
                        ...
                        UpdatedC3 ->
                            ?NEW_INTERNAL2(K1, K2, Values, C1, C2, UpdatedC3)
                    end;
                true ->
                    error_key_exists(Key)
            end;
        Key < K1 ->
            case insert_recur(Key, ValueEval, ValueWrap, C1) of
                ...
                UpdatedC1 ->
                    ?NEW_INTERNAL2(K1, K2, Values, UpdatedC1, C2, C3)
            end;
        true ->
            error_key_exists(Key)
    end.
...
update_recur(Key, ValueEval, ValueWrap, ?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    update_internal3(Key, ValueEval, ValueWrap, K1, K2, K3, Values, C1, C2, C3, C4);
update_recur(Key, ValueEval, ValueWrap, ?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    update_internal2(Key, ValueEval, ValueWrap, K1, K2, Values, C1, C2, C3);
update_recur(Key, ValueEval, ValueWrap, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    update_leaf4(Key, ValueEval, ValueWrap, K1, K2, K3, K4, V1, V2, V3, V4);
update_recur(Key, ValueEval, ValueWrap, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    update_leaf3(Key, ValueEval, ValueWrap, K1, K2, K3, V1, V2, V3);
update_recur(Key, ValueEval, ValueWrap, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
    ...
    if
        Key > K1 ->
            if
                Key < K2 ->
                    ?NEW_INTERNAL2(
                        K1, K2, Values, C1, update_recur(Key, ValueEval, ValueWrap, C2), C3
                    );
                Key > K2 ->
                    ?NEW_INTERNAL2(
                        K1, K2, Values, C1, C2, update_recur(Key, ValueEval, ValueWrap, C3)
                    );
                true ->
                    [V1 | V2] = Values,
                    Value = eval_update_value(ValueEval, ValueWrap, V2),
                    ?NEW_INTERNAL2(K1, Key, [V1 | Value], C1, C2, C3)
            end;
        Key < K1 ->
            ?NEW_INTERNAL2(K1, K2, Values, update_recur(Key, ValueEval, ValueWrap, C1), C2, C3);
        true ->
            [V1 | V2] = Values,
            Value = eval_update_value(ValueEval, ValueWrap, V1),
            ?NEW_INTERNAL2(Key, K2, [Value | V2], C1, C2, C3)
    end.
...
update_internal1(Key, ValueEval, ValueWrap, K1, V1, C1, C2) ->
    if
        Key < K1 ->
            ?NEW_INTERNAL1(K1, V1, update_recur(Key, ValueEval, ValueWrap, C1), C2);
        Key > K1 ->
            ?NEW_INTERNAL1(K1, V1, C1, update_recur(Key, ValueEval, ValueWrap, C2));
        true ->
            Value = eval_update_value(ValueEval, ValueWrap, V1),
            ?NEW_INTERNAL1(Key, Value, C1, C2)
    end.
    ...
    if
        Key > K2 ->
            if
                Key == K3 ->
                    Value = eval_update_value(ValueEval, ValueWrap, V3),
                    ?NEW_LEAF4(K1, K2, Key, K4, V1, V2, Value, V4);
                Key == K4 ->
                    Value = eval_update_value(ValueEval, ValueWrap, V4),
        ...
        Key == K2 ->
            Value = eval_update_value(ValueEval, ValueWrap, V2),
            ?NEW_LEAF4(K1, Key, K3, K4, V1, Value, V3, V4);
        Key == K1 ->
            Value = eval_update_value(ValueEval, ValueWrap, V1),
            ?NEW_LEAF4(Key, K2, K3, K4, Value, V2, V3, V4);
        true ->
            error_badkey(Key)
    end.
    ...
    if
        Key < K2 ->
            if
                Key == K1 ->
                    Value = eval_update_value(ValueEval, ValueWrap, V1),
                    ?NEW_LEAF3(Key, K2, K3, Value, V2, V3);
                true ->
                    error_badkey(Key)
            end;
        Key > K2 ->
        ...
        true ->
            Value = eval_update_value(ValueEval, ValueWrap, V2),
            ?NEW_LEAF3(K1, Key, K3, V1, Value, V3)
    end.
...
delete(K, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    delete_internal1(K, K1, V1, C1, C2);
delete(K, ?MATCH_LEAF1(K1, _)) ->
    delete_leaf1(K, K1);
delete(K, ?MATCH_LEAF0) ->
    error_badkey(K);
delete(K, Root) ->
    delete_recur(K, Root).
...
delete_recur(K, ?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)) ->
    delete_internal4(K, K1, K2, K3, K4, Values, C1, C2, C3, C4, C5);
delete_recur(K, ?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    delete_internal3(K, K1, K2, K3, Values, C1, C2, C3, C4);
delete_recur(K, ?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    delete_internal2(K, K1, K2, Values, C1, C2, C3);
delete_recur(K, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    delete_leaf4(K, K1, K2, K3, K4, V1, V2, V3, V4);
delete_recur(K, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    delete_leaf3(K, K1, K2, K3, V1, V2, V3);
delete_recur(K, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
...
delete_internal4_rebalance_child1(K1, K2, K3, K4, V1, V2, V3, V4, C1, C2, C3, C4, C5) ->
    case maybe_rebalance_left(C1, K1, V1, C2) of
        no ->
            ?NEW_INTERNAL4(K1, K2, K3, K4, {V1, V2, V3, V4}, C1, C2, C3, C4, C5);
        {UpK, UpVal, UpdatedC1, UpdatedC2} ->
            ?NEW_INTERNAL4(UpK, K2, K3, K4, {UpVal, V2, V3, V4}, UpdatedC1, UpdatedC2, C3, C4, C5);
        {merged, MergedC1C2} ->
            ?NEW_INTERNAL3(K2, K3, K4, {V2, V3, V4}, MergedC1C2, C3, C4, C5)
    end.
...
delete_internal4_rebalance_child2(K1, K2, K3, K4, V1, V2, V3, V4, C1, C2, C3, C4, C5) ->
    case maybe_rebalance_mid(C1, K1, V1, C2, K2, V2, C3) of
        ...
        {from_left, {UpK, UpVal, UpdatedC1, RebalancedC2}} ->
            ?NEW_INTERNAL4(
                UpK, K2, K3, K4, {UpVal, V2, V3, V4}, UpdatedC1, RebalancedC2, C3, C4, C5
            );
        {from_right, {UpK, UpVal, RebalancedC2, UpdatedC3}} ->
            ?NEW_INTERNAL4(
                K1, UpK, K3, K4, {V1, UpVal, V3, V4}, C1, RebalancedC2, UpdatedC3, C4, C5
            );
...
delete_internal4_rebalance_child3(K1, K2, K3, K4, V1, V2, V3, V4, C1, C2, C3, C4, C5) ->
    case maybe_rebalance_mid(C2, K2, V2, C3, K3, V3, C4) of
        ...
        {from_left, {merged, MergedC2C3}} ->
            ?NEW_INTERNAL3(K1, K3, K4, {V1, V3, V4}, C1, MergedC2C3, C4, C5)
    end.
...
delete_internal4_rebalance_child4(K1, K2, K3, K4, V1, V2, V3, V4, C1, C2, C3, C4, C5) ->
    case maybe_rebalance_mid(C3, K3, V3, C4, K4, V4, C5) of
        ...
        {from_left, {merged, MergedC3C4}} ->
            ?NEW_INTERNAL3(K1, K2, K4, {V1, V2, V4}, C1, C2, MergedC3C4, C5)
    end.
...
delete_internal4_rebalance_child5(K1, K2, K3, K4, V1, V2, V3, V4, C1, C2, C3, C4, C5) ->
    case maybe_rebalance_right(C4, K4, V4, C5) of
        ...
        {merged, MergedC4C5} ->
            ?NEW_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, MergedC4C5)
    end.
...
delete_internal3_rebalance_child1(K1, K2, K3, V1, V2, V3, C1, C2, C3, C4) ->
    case maybe_rebalance_left(C1, K1, V1, C2) of
        no ->
            ?NEW_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4);
        {UpK, UpVal, UpdatedC1, UpdatedC2} ->
            ?NEW_INTERNAL3(UpK, K2, K3, {UpVal, V2, V3}, UpdatedC1, UpdatedC2, C3, C4);
        {merged, MergedC1C2} ->
            ?NEW_INTERNAL2(K2, K3, [V2 | V3], MergedC1C2, C3, C4)
    end.
...
delete_internal3_rebalance_child2(K1, K2, K3, V1, V2, V3, C1, C2, C3, C4) ->
    case maybe_rebalance_mid(C1, K1, V1, C2, K2, V2, C3) of
        no ->
            ?NEW_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4);
        {from_left, {UpK, UpVal, UpdatedC1, RebalancedC2}} ->
            ?NEW_INTERNAL3(UpK, K2, K3, {UpVal, V2, V3}, UpdatedC1, RebalancedC2, C3, C4);
        {from_right, {UpK, UpVal, RebalancedC2, UpdatedC3}} ->
            ?NEW_INTERNAL3(K1, UpK, K3, {V1, UpVal, V3}, C1, RebalancedC2, UpdatedC3, C4);
        {from_left, {merged, MergedC1C2}} ->
            ?NEW_INTERNAL2(K2, K3, [V2 | V3], MergedC1C2, C3, C4)
    end.
...
delete_internal3_rebalance_child3(K1, K2, K3, V1, V2, V3, C1, C2, C3, C4) ->
    case maybe_rebalance_mid(C2, K2, V2, C3, K3, V3, C4) of
        no ->
            ?NEW_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4);
        {from_left, {UpK, UpVal, UpdatedC2, RebalancedC3}} ->
            ?NEW_INTERNAL3(K1, UpK, K3, {V1, UpVal, V3}, C1, UpdatedC2, RebalancedC3, C4);
        {from_right, {UpK, UpVal, RebalancedC3, UpdatedC4}} ->
            ?NEW_INTERNAL3(K1, K2, UpK, {V1, V2, UpVal}, C1, C2, RebalancedC3, UpdatedC4);
        {from_left, {merged, MergedC2C3}} ->
            ?NEW_INTERNAL2(K1, K3, [V1 | V3], C1, MergedC2C3, C4)
    end.
...
delete_internal3_rebalance_child4(K1, K2, K3, V1, V2, V3, C1, C2, C3, C4) ->
    case maybe_rebalance_right(C3, K3, V3, C4) of
        ...
        {UpK, UpVal, UpdatedC3, RebalancedC4} ->
            ?NEW_INTERNAL3(K1, K2, UpK, {V1, V2, UpVal}, C1, C2, UpdatedC3, RebalancedC4);
        {merged, MergedC3C4} ->
            ?NEW_INTERNAL2(K1, K2, [V1 | V2], C1, C2, MergedC3C4)
    end.
...
delete_internal2_rebalance_child1(K1, K2, V1, V2, C1, C2, C3) ->
    case maybe_rebalance_left(C1, K1, V1, C2) of
        no ->
            ?NEW_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3);
        {UpK, UpVal, UpdatedC1, UpdatedC2} ->
            ?NEW_INTERNAL2(UpK, K2, [UpVal | V2], UpdatedC1, UpdatedC2, C3);
        {merged, MergedC1C2} ->
...
delete_internal2_rebalance_child2(K1, K2, V1, V2, C1, C2, C3) ->
    case maybe_rebalance_mid(C1, K1, V1, C2, K2, V2, C3) of
        no ->
            ?NEW_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3);
        {from_left, {UpK, UpVal, UpdatedC1, RebalancedC2}} ->
            ?NEW_INTERNAL2(UpK, K2, [UpVal | V2], UpdatedC1, RebalancedC2, C3);
        {from_right, {UpK, UpVal, RebalancedC2, UpdatedC3}} ->
            ?NEW_INTERNAL2(K1, UpK, [V1 | UpVal], C1, RebalancedC2, UpdatedC3);
        {from_left, {merged, MergedC1C2}} ->
            ?NEW_INTERNAL1(K2, V2, MergedC1C2, C3)
    end.
...
delete_internal2_rebalance_child3(K1, K2, V1, V2, C1, C2, C3) ->
    case maybe_rebalance_right(C2, K2, V2, C3) of
        ...
        {UpK, UpVal, UpdatedC2, RebalancedC3} ->
            ?NEW_INTERNAL2(K1, UpK, [V1 | UpVal], C1, UpdatedC2, RebalancedC3);
        {merged, MergedC2C3} ->
            ?NEW_INTERNAL1(K1, V1, C1, MergedC2C3)
    end.
...
delete_internal1_rebalance_child1(K1, V1, C1, C2) ->
    case maybe_rebalance_left(C1, K1, V1, C2) of
        no ->
            ?NEW_INTERNAL1(K1, V1, C1, C2);
        {UpK, UpVal, UpdatedC1, UpdatedC2} ->
            ?NEW_INTERNAL1(UpK, UpVal, UpdatedC1, UpdatedC2);
        {merged, MergedC1C2} ->
...
delete_internal1_rebalance_child2(K1, V1, C1, C2) ->
    case maybe_rebalance_right(C1, K1, V1, C2) of
        ...
        {UpK, UpVal, UpdatedC1, RebalancedC2} ->
            ?NEW_INTERNAL1(UpK, UpVal, UpdatedC1, RebalancedC2);
        {merged, MergedC1C2} ->
            % This can only happen on root - height is reduced
            MergedC1C2
    end.
...
root_take_smallest(?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
...
root_take_smallest(?MATCH_LEAF1(K1, V1)) ->
    {{K1, V1}, ?MATCH_LEAF0};
root_take_smallest(?MATCH_LEAF0) ->
    error_empty_tree();
root_take_smallest(Node) ->
    take_smallest_recur(Node).

take_smallest_recur(?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)) ->
    {TakenPair, UpdatedC1} = take_smallest_recur(C1),
    {V1, V2, V3, V4} = Values,
...
take_smallest_recur(?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    {TakenPair, UpdatedC1} = take_smallest_recur(C1),
    {V1, V2, V3} = Values,
...
take_smallest_recur(?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    {TakenPair, UpdatedC1} = take_smallest_recur(C1),
    [V1 | V2] = Values,
...
take_smallest_recur(?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    {{K1, V1}, ?NEW_LEAF3(K2, K3, K4, V2, V3, V4)};
take_smallest_recur(?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    {{K1, V1}, ?NEW_LEAF2(K2, K3, V2, V3)};
take_smallest_recur(?MATCH_LEAF2(K1, K2, V1, V2)) ->
    {{K1, V1}, ?NEW_LEAF1(K2, V2)}.

%% ------------------------------------------------------------------
%% Internal Function Definitions: Node Taking - Largest
%% ------------------------------------------------------------------

root_take_largest(?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
...
root_take_largest(?MATCH_LEAF1(K1, V1)) ->
    {{K1, V1}, ?NEW_LEAF0};
root_take_largest(?MATCH_LEAF0) ->
    error_empty_tree();
root_take_largest(Node) ->
    take_largest_recur(Node).

take_largest_recur(?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)) ->
...
take_largest_recur(?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
...
take_largest_recur(?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
...
take_largest_recur(?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    {{K4, V4}, ?NEW_LEAF3(K1, K2, K3, V1, V2, V3)};
take_largest_recur(?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    {{K3, V3}, ?NEW_LEAF2(K1, K2, V1, V2)};
take_largest_recur(?MATCH_LEAF2(K1, K2, V1, V2)) ->
    {{K2, V2}, ?NEW_LEAF1(K1, V1)}.
...
root_take(K, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    take_internal1(K, K1, V1, C1, C2);
root_take(K, ?MATCH_LEAF1(K1, V1)) ->
    take_leaf1(K, K1, V1);
root_take(K, ?MATCH_LEAF0) ->
    error_badkey(K);
root_take(K, Root) ->
    take_recur(K, Root).
...
take_recur(K, ?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)) ->
    take_internal4(K, K1, K2, K3, K4, Values, C1, C2, C3, C4, C5);
take_recur(K, ?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    take_internal3(K, K1, K2, K3, Values, C1, C2, C3, C4);
take_recur(K, ?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    take_internal2(K, K1, K2, Values, C1, C2, C3);
take_recur(K, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    take_leaf4(K, K1, K2, K3, K4, V1, V2, V3, V4);
take_recur(K, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    take_leaf3(K, K1, K2, K3, V1, V2, V3);
take_recur(K, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
...
-compile({inline, take_internal4/11}).
take_internal4(K, K1, K2, K3, K4, Values, C1, C2, C3, C4, C5) ->
    if
        K > K2 ->
            if
                    ...
                    if
                        K > K3 ->
                            take_internal4_child4(
                                K, K1, K2, K3, K4, Values, C1, C2, C3, C4, C5
                            );
                        K < K3 ->
...
-compile({inline, take_internal3/9}).
take_internal3(K, K1, K2, K3, Values, C1, C2, C3, C4) ->
    if
        K > K2 ->
            if
...
-compile({inline, take_internal2/7}).
take_internal2(K, K1, K2, Values, C1, C2, C3) ->
    if
        K > K1 ->
            if
...
take_leaf4(K, K1, K2, K3, K4, V1, V2, V3, V4) ->
    if
        K > K2 ->
            if
                K == K3 ->
                    {{K3, V3}, ?NEW_LEAF3(K1, K2, K4, V1, V2, V4)};
                K == K4 ->
                    {{K4, V4}, ?NEW_LEAF3(K1, K2, K3, V1, V2, V3)};
                true ->
                    error_badkey(K)
        ...
        K == K2 ->
            {{K2, V2}, ?NEW_LEAF3(K1, K3, K4, V1, V3, V4)};
        K == K1 ->
            {{K1, V1}, ?NEW_LEAF3(K2, K3, K4, V2, V3, V4)};
        true ->
            error_badkey(K)
...
rebalance_left_internal1(LeftK1, LeftV1, LeftC1, LeftC2, ParentK, ParentV, Right, Merge) ->
    case Right of
        ...
        ?MATCH_INTERNAL3(
            ...
            {UpK, UpVal, UpdatedLeft, UpdatedRight};
        ?MATCH_INTERNAL2(RightK1, RightK2, [RightV1 | RightV2], RightC1, RightC2, RightC3) ->
            if
                Merge ->
                    {merged,
                        ?NEW_INTERNAL4(
...
rebalance_left_leaf1(LeftK1, LeftV1, ParentK, ParentV, Right, Merge) ->
    case Right of
        ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4) ->
            UpK = K1,
            UpVal = V1,
            UpdatedLeft = ?NEW_LEAF2(LeftK1, ParentK, LeftV1, ParentV),
            UpdatedRight = ?NEW_LEAF3(K2, K3, K4, V2, V3, V4),
            {UpK, UpVal, UpdatedLeft, UpdatedRight};
        ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3) ->
            UpK = K1,
            UpVal = V1,
            UpdatedLeft = ?NEW_LEAF2(LeftK1, ParentK, LeftV1, ParentV),
            UpdatedRight = ?NEW_LEAF2(K2, K3, V2, V3),
            {UpK, UpVal, UpdatedLeft, UpdatedRight};
        ?MATCH_LEAF2(K1, K2, V1, V2) ->
            if
                Merge ->
                    {merged,
                        ?NEW_LEAF4(
...
rebalance_right_internal1(RightK1, RightV1, RightC1, RightC2, ParentK, ParentV, Left) ->
    case Left of
        ...
        ?MATCH_INTERNAL3(
            ...
            UpdatedLeft = ?MATCH_INTERNAL2(
                LeftK1, LeftK2, [LeftV1 | LeftV2], LeftC1, LeftC2, LeftC3
            ),
            ...
            {UpK, UpVal, UpdatedLeft, UpdatedRight};
        ?MATCH_INTERNAL2(LeftK1, LeftK2, [LeftV1 | LeftV2], LeftC1, LeftC2, LeftC3) ->
            {merged,
                ?NEW_INTERNAL4(
                    LeftK1,
                    LeftK2,
...
rebalance_right_leaf1(RightK1, RightV1, ParentK, ParentV, Left) ->
    case Left of
        ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4) ->
            ...
            UpdatedRight = ?NEW_LEAF2(ParentK, RightK1, ParentV, RightV1),
            {UpK, UpVal, UpdatedLeft, UpdatedRight};
        ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3) ->
            UpK = K3,
            UpVal = V3,
...
stats_recur(?MATCH_INTERNAL4(_, _, _, _, _, C1, C2, C3, C4, C5), Depth, Acc) ->
    ...
    Acc7;
stats_recur(?MATCH_INTERNAL3(_, _, _, _, C1, C2, C3, C4), Depth, Acc) ->
    ...
    Acc6 = stats_recur(C4, Depth + 1, Acc5),
    Acc6;
stats_recur(?MATCH_INTERNAL2(_, _, _, C1, C2, C3), Depth, Acc) ->
    Acc2 = stats_inc_node_count(Acc, internal2),
    Acc3 = stats_recur(C1, Depth + 1, Acc2),
    Acc4 = stats_recur(C2, Depth + 1, Acc3),
    Acc5 = stats_recur(C3, Depth + 1, Acc4),
    Acc5;
stats_recur(?MATCH_INTERNAL1(_, _, C1, C2), Depth, Acc) ->
    Acc2 =
        case Depth of
            1 -> Acc;
    ...
    Acc5;
stats_recur(?MATCH_LEAF4(_, _, _, _, _, _, _, _), Depth, Acc) ->
    Acc2 = stats_inc_node_count(Acc, leaf4),
    Acc3 = stats_register_leaf_height(Acc2, Depth),
    Acc3;
stats_recur(?MATCH_LEAF3(_, _, _, _, _, _), Depth, Acc) ->
    Acc2 = stats_inc_node_count(Acc, leaf3),
    Acc3 = stats_register_leaf_height(Acc2, Depth),
    Acc3;
stats_recur(?MATCH_LEAF2(_, _, _, _), Depth, Acc) ->
    Acc2 = stats_inc_node_count(Acc, leaf2),
    Acc3 = stats_register_leaf_height(Acc2, Depth),
    Acc3;
stats_recur(?MATCH_LEAF1(_, _), Depth, Acc) ->
    Acc2 =
        case Depth of
            1 -> Acc;
...
foldl_recur(Fun, Acc, ?MATCH_INTERNAL4(K1, K2, K3, K4, {V1, V2, V3, V4}, C1, C2, C3, C4, C5)) ->
    Acc2 = Fun(K1, V1, foldl_recur(Fun, Acc, C1)),
...
foldl_recur(Fun, Acc, ?MATCH_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4)) ->
    Acc2 = Fun(K1, V1, foldl_recur(Fun, Acc, C1)),
    Acc3 = Fun(K2, V2, foldl_recur(Fun, Acc2, C2)),
    Acc4 = Fun(K3, V3, foldl_recur(Fun, Acc3, C3)),
    foldl_recur(Fun, Acc4, C4);
foldl_recur(Fun, Acc, ?MATCH_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3)) ->
    Acc2 = Fun(K1, V1, foldl_recur(Fun, Acc, C1)),
    Acc3 = Fun(K2, V2, foldl_recur(Fun, Acc2, C2)),
    foldl_recur(Fun, Acc3, C3);
foldl_recur(Fun, Acc, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    Acc2 = Fun(K1, V1, Acc),
    Acc3 = Fun(K2, V2, Acc2),
    Acc4 = Fun(K3, V3, Acc3),
    Acc5 = Fun(K4, V4, Acc4),
    Acc5;
foldl_recur(Fun, Acc, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    Acc2 = Fun(K1, V1, Acc),
    Acc3 = Fun(K2, V2, Acc2),
    Acc4 = Fun(K3, V3, Acc3),
    Acc4;
foldl_recur(Fun, Acc, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
    Acc2 = Fun(K1, V1, Acc),
    Acc3 = Fun(K2, V2, Acc2),
    Acc3.
...
foldr_recur(Fun, Acc, ?MATCH_INTERNAL4(K1, K2, K3, K4, {V1, V2, V3, V4}, C1, C2, C3, C4, C5)) ->
...
foldr_recur(Fun, Acc, ?MATCH_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4)) ->
...
foldr_recur(Fun, Acc, ?MATCH_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3)) ->
    Acc2 = Fun(K2, V2, foldr_recur(Fun, Acc, C3)),
    Acc3 = Fun(K1, V1, foldr_recur(Fun, Acc2, C2)),
    foldr_recur(Fun, Acc3, C1);
foldr_recur(Fun, Acc, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    Acc2 = Fun(K4, V4, Acc),
    Acc3 = Fun(K3, V3, Acc2),
    Acc4 = Fun(K2, V2, Acc3),
    Acc5 = Fun(K1, V1, Acc4),
    Acc5;
foldr_recur(Fun, Acc, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    Acc2 = Fun(K3, V3, Acc),
    Acc3 = Fun(K2, V2, Acc2),
    Acc4 = Fun(K1, V1, Acc3),
    Acc4;
foldr_recur(Fun, Acc, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
    Acc2 = Fun(K2, V2, Acc),
    Acc3 = Fun(K1, V1, Acc2),
    Acc3.
...
iterator_steps_l(?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    iterator_steps_l_recur(C1, [{K1, V1, C2}]);
iterator_steps_l(?MATCH_LEAF1(K1, V1)) ->
    [{K1, V1}];
iterator_steps_l(?MATCH_LEAF0) ->
    [];
...
iterator_steps_l_recur(Node, Acc) ->
    case Node of
        ?MATCH_INTERNAL4(K1, K2, K3, K4, {V1, V2, V3, V4}, C1, C2, C3, C4, C5) ->
            iterator_steps_l_recur(C1, [
                {K1, V1, C2}, {K2, V2, C3}, {K3, V3, C4}, {K4, V4, C5} | Acc
            ]);
        ?MATCH_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4) ->
            iterator_steps_l_recur(C1, [{K1, V1, C2}, {K2, V2, C3}, {K3, V3, C4} | Acc]);
        ?MATCH_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3) ->
...
iterator_steps_l_from(Key, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    if
        Key < K1 ->
...
iterator_steps_l_from(Key, ?MATCH_LEAF1(K1, V1)) ->
    if
        Key > K1 ->
            [];
        true ->
...
iterator_steps_l_from(_, ?MATCH_LEAF0) ->
    [];
...
iterator_steps_l_from_recur(
    Key, ?MATCH_INTERNAL4(K1, K2, K3, K4, {V1, V2, V3, V4}, C1, C2, C3, C4, C5), Acc
) ->
    if
        Key < K2 ->
            if
...
iterator_steps_l_from_recur(Key, ?MATCH_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4), Acc) ->
    if
        Key < K2 ->
            if
                Key < K1 ->
...
iterator_steps_l_from_recur(Key, ?MATCH_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3), Acc) ->
    if
        Key < K2 ->
            if
                Key < K1 ->
...
iterator_steps_l_from_recur(Key, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4), Acc) ->
    if
        Key > K2 ->
            if
                Key > K3 ->
...
iterator_steps_l_from_recur(Key, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3), Acc) ->
    if
        Key > K2 ->
            if
                Key > K3 ->
...
iterator_steps_l_from_recur(Key, ?MATCH_LEAF2(K1, K2, V1, V2), Acc) ->
    if
        Key > K2 ->
            Acc;
        Key > K1 ->
...
iterator_steps_r(?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    iterator_steps_r_recur(C2, [{K1, V1, C1}]);
iterator_steps_r(?MATCH_LEAF1(K1, V1)) ->
    [{K1, V1}];
iterator_steps_r(?MATCH_LEAF0) ->
    [];
...
iterator_steps_r_from(Key, ?MATCH_LEAF1(K1, V1)) ->
    if
        Key < K1 ->
            [];
        true ->
...
iterator_steps_r_from(Key, ?MATCH_INTERNAL1(K1, V1, C1, C2)) ->
    if
        Key > K1 ->
...
iterator_steps_r_from(_, ?MATCH_LEAF0) ->
    [];
...
iterator_steps_r_from_recur(Key, ?MATCH_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4), Acc) ->
    if
        Key > K2 ->
            if
                Key > K3 ->
...
iterator_steps_r_from_recur(Key, ?MATCH_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3), Acc) ->
    if
        Key > K1 ->
            if
                Key > K2 ->
...
iterator_steps_r_from_recur(Key, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4), Acc) ->
    if
        Key < K2 ->
            if
                Key < K1 ->
...
iterator_steps_r_from_recur(Key, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3), Acc) ->
    if
        Key < K2 ->
            if
                Key < K1 ->
...
iterator_steps_r_from_recur(Key, ?MATCH_LEAF2(K1, K2, V1, V2), Acc) ->
    if
        Key < K1 ->
            Acc;
        Key < K2 ->
...
keys_recur(?MATCH_INTERNAL4(K1, K2, K3, K4, _, C1, C2, C3, C4, C5), Acc) ->
    Acc2 = [K4 | keys_recur(C5, Acc)],
    Acc3 = [K3 | keys_recur(C4, Acc2)],
    Acc4 = [K2 | keys_recur(C3, Acc3)],
    Acc5 = [K1 | keys_recur(C2, Acc4)],
    keys_recur(C1, Acc5);
keys_recur(?MATCH_INTERNAL3(K1, K2, K3, _, C1, C2, C3, C4), Acc) ->
    Acc2 = [K3 | keys_recur(C4, Acc)],
    Acc3 = [K2 | keys_recur(C3, Acc2)],
    Acc4 = [K1 | keys_recur(C2, Acc3)],
    keys_recur(C1, Acc4);
keys_recur(?MATCH_INTERNAL2(K1, K2, _, C1, C2, C3), Acc) ->
    Acc2 = [K2 | keys_recur(C3, Acc)],
    Acc3 = [K1 | keys_recur(C2, Acc2)],
    keys_recur(C1, Acc3);
keys_recur(?MATCH_LEAF4(K1, K2, K3, K4, _, _, _, _), Acc) ->
    [K1, K2, K3, K4 | Acc];
keys_recur(?MATCH_LEAF3(K1, K2, K3, _, _, _), Acc) ->
    [K1, K2, K3 | Acc];
keys_recur(?MATCH_LEAF2(K1, K2, _, _), Acc) ->
    [K1, K2 | Acc].

-spec values_recur(deep_node(_, Value), [Value]) -> [Value, ...].
-dialyzer({no_underspecs, values_recur/2}).
values_recur(?MATCH_INTERNAL4(_, _, _, _, {V1, V2, V3, V4}, C1, C2, C3, C4, C5), Acc) ->
...
values_recur(?MATCH_INTERNAL3(_, _, _, {V1, V2, V3}, C1, C2, C3, C4), Acc) ->
    Acc2 = [V3 | values_recur(C4, Acc)],
    Acc3 = [V2 | values_recur(C3, Acc2)],
    Acc4 = [V1 | values_recur(C2, Acc3)],
    values_recur(C1, Acc4);
values_recur(?MATCH_INTERNAL2(_, _, [V1 | V2], C1, C2, C3), Acc) ->
    Acc2 = [V2 | values_recur(C3, Acc)],
    Acc3 = [V1 | values_recur(C2, Acc2)],
    values_recur(C1, Acc3);
values_recur(?MATCH_LEAF4(_, _, _, _, V1, V2, V3, V4), Acc) ->
    [V1, V2, V3, V4 | Acc];
values_recur(?MATCH_LEAF3(_, _, _, V1, V2, V3), Acc) ->
    [V1, V2, V3 | Acc];
values_recur(?MATCH_LEAF2(_, _, V1, V2), Acc) ->
    [V1, V2 | Acc].

-spec to_list_recur(deep_node(Key, Value), [{Key, Value}]) -> [{Key, Value}, ...].
-dialyzer({no_underspecs, to_list_recur/2}).
to_list_recur(?MATCH_INTERNAL4(K1, K2, K3, K4, {V1, V2, V3, V4}, C1, C2, C3, C4, C5), Acc) ->
...
to_list_recur(?MATCH_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4), Acc) ->
    Acc2 = [{K3, V3} | to_list_recur(C4, Acc)],
    Acc3 = [{K2, V2} | to_list_recur(C3, Acc2)],
    Acc4 = [{K1, V1} | to_list_recur(C2, Acc3)],
    to_list_recur(C1, Acc4);
to_list_recur(?MATCH_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3), Acc) ->
    Acc2 = [{K2, V2} | to_list_recur(C3, Acc)],
    Acc3 = [{K1, V1} | to_list_recur(C2, Acc2)],
    to_list_recur(C1, Acc3);
to_list_recur(?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4), Acc) ->
    [{K1, V1}, {K2, V2}, {K3, V3}, {K4, V4} | Acc];
to_list_recur(?MATCH_LEAF3(K1, K2, K3, V1, V2, V3), Acc) ->
    [{K1, V1}, {K2, V2}, {K3, V3} | Acc];
to_list_recur(?MATCH_LEAF2(K1, K2, V1, V2), Acc) ->
    [{K1, V1}, {K2, V2} | Acc].

-spec largest_recur(deep_node(Key, Value)) -> {Key, Value}.
largest_recur(?MATCH_INTERNAL4(_, _, _, _, _, _, _, _, _, C5)) ->
    largest_recur(C5);
largest_recur(?MATCH_INTERNAL3(_, _, _, _, _, _, _, C4)) ->
    largest_recur(C4);
largest_recur(?MATCH_INTERNAL2(_, _, _, _, _, C3)) ->
    largest_recur(C3);
largest_recur(?MATCH_LEAF4(_, _, _, K4, _, _, _, V4)) ->
    {K4, V4};
largest_recur(?MATCH_LEAF3(_, _, K3, _, _, V3)) ->
    {K3, V3};
largest_recur(?MATCH_LEAF2(_, K2, _, V2)) ->
    {K2, V2}.

-spec smallest_recur(deep_node(Key, Value)) -> {Key, Value}.
smallest_recur(?MATCH_INTERNAL4(_, _, _, _, _, C1, _, _, _, _)) ->
    smallest_recur(C1);
smallest_recur(?MATCH_INTERNAL3(_, _, _, _, C1, _, _, _)) ->
    smallest_recur(C1);
smallest_recur(?MATCH_INTERNAL2(_, _, _, C1, _, _)) ->
    smallest_recur(C1);
smallest_recur(?MATCH_LEAF4(K1, _, _, _, V1, _, _, _)) ->
    {K1, V1};
smallest_recur(?MATCH_LEAF3(K1, _, _, V1, _, _)) ->
    {K1, V1};
smallest_recur(?MATCH_LEAF2(K1, _, V1, _)) ->
    {K1, V1}.
...
larger_recur(Key, ?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)) ->
    case Key < K2 of
        true ->
            case Key < K1 of
                true ->
...
larger_recur(Key, ?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    case Key < K2 of
        true ->
            case Key < K1 of
                true ->
...
larger_recur(Key, ?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    case Key < K2 of
        true ->
            case Key < K1 of
                true ->
...
larger_recur(Key, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    case Key < K2 of
        true ->
            case Key < K1 of
                true ->
...
larger_recur(Key, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    case Key < K2 of
        true ->
            case Key < K1 of
                true ->
...
larger_recur(Key, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
    case Key < K2 of
        true ->
            case Key < K1 of
                true ->
...
smaller_recur(Key, ?MATCH_INTERNAL4(K1, K2, K3, K4, Values, C1, C2, C3, C4, C5)) ->
    case Key > K2 of
        true ->
            case Key > K3 of
                true ->
...
smaller_recur(Key, ?MATCH_INTERNAL3(K1, K2, K3, Values, C1, C2, C3, C4)) ->
    case Key > K2 of
        true ->
            case Key > K3 of
                true ->
...
smaller_recur(Key, ?MATCH_INTERNAL2(K1, K2, Values, C1, C2, C3)) ->
    case Key > K1 of
        true ->
            case Key > K2 of
                true ->
...
smaller_recur(Key, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    case Key > K2 of
        true ->
            case Key > K3 of
                true ->
...
smaller_recur(Key, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    case Key > K2 of
        true ->
            case Key > K3 of
                true ->
...
smaller_recur(Key, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
    case Key > K1 of
        true ->
            case Key > K2 of
                true ->
...
map_recur(Fun, ?MATCH_INTERNAL4(K1, K2, K3, K4, {V1, V2, V3, V4}, C1, C2, C3, C4, C5)) ->
    ?NEW_INTERNAL4(
        K1,
        K2,
        K3,
...
map_recur(Fun, ?MATCH_INTERNAL3(K1, K2, K3, {V1, V2, V3}, C1, C2, C3, C4)) ->
    ?NEW_INTERNAL3(
        K1,
        K2,
        K3,
...
map_recur(Fun, ?MATCH_INTERNAL2(K1, K2, [V1 | V2], C1, C2, C3)) ->
    ?NEW_INTERNAL2(
        K1,
        K2,
        [Fun(K1, V1) | Fun(K2, V2)],
...
map_recur(Fun, ?MATCH_LEAF4(K1, K2, K3, K4, V1, V2, V3, V4)) ->
    ?NEW_LEAF4(
        K1,
        K2,
        K3,
...
map_recur(Fun, ?MATCH_LEAF3(K1, K2, K3, V1, V2, V3)) ->
    ?NEW_LEAF3(
        K1,
        K2,
        K3,
...
map_recur(Fun, ?MATCH_LEAF2(K1, K2, V1, V2)) ->
    ?NEW_LEAF2(
        K1,
        K2,
        Fun(K1, V1),
