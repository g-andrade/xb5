...
test_node_validate_leaf1_deep_in_the_tree(_Config) ->
    ...
    ?assertEqual(
        ...
        b5_trees_v2_node:validate(4, Root)
    ).
...
test_node_validate_inconsistent_heights(_Config) ->
    ...
    ?assertMatch(
        ...
        b5_trees_v2_node:validate(9, Root)
    ).
...
test_node_validate_inconsistent_keys(_Config) ->
    ...
    ?assertMatch(
        ...
        b5_trees_v2_node:validate(6, Root)
    ).
...
test_constituent_parts(_Config) ->
    ...
    ?assertMatch({ok, _}, b5_trees_v2:validate(ReconstructedTree)),
...
test_inserts(Tree, ExistentKvs, []) ->
    ...
    ?assertMatch({ok, _}, b5_trees_v2:validate(Tree)),
...
test_inserts(Tree, ExistentKvs, [NonExistentKey | Rest]) ->
    ...
    ?assertMatch({ok, _}, b5_trees_v2:validate(Tree2)),
