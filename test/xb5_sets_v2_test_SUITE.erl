...
run_smaller(RefElements, Set) ->
    case RefElements of
        ...
        %
        [SingleElement] ->
            ?assertEqual(none, xb5_sets_v2:smaller(randomly_switch_number_type(SingleElement), Set)),
        ...
        fun(RefElements2, Set2) ->
            foreach_second_set(
                fun(RefElements3, Set3) ->
                    ...
                    ?assertEqual(length(ExpectedRemainingElements), xb5_sets_v2:size(Intersection2)),
                    ...
                    ?assertEqual(length(ExpectedRemainingElements), xb5_sets_v2:size(Intersection3)),
